                ...
                <span>
                  {editedCategory ? (
                    <>
                      ...
                      &nbsp;
                      {/* <span className="font-bold text-blue-500">{editedCategory?.parent?.name}</span> */}
                    </>
                  ) : (
                            ...
                            <div className="relative p-5">
                              <div className="text-center">
                                ...
                                <div>
                                  ...
                                  <div className="max-w-sm mt-2 text-sm text-gray-500">
                              ...
                              <div className="flex justify-end gap-3 mt-5">
                                <button
                                  onClick={closeModal}
                                  className="flex-1 px-4 py-2 text-sm font-medium text-center text-gray-700 transition-all bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-100 focus:ring focus:ring-gray-100 disabled:cursor-not-allowed disabled:border-gray-100 disabled:bg-gray-50 disabled:text-gray-400"
                                >
                                  Cancel
                                </button>
                                <button
                                  className="flex-1 px-4 py-2 text-sm font-medium text-center text-white transition-all bg-red-500 border border-red-500 rounded-lg shadow-sm hover:border-red-700 hover:bg-red-700 focus:ring focus:ring-red-200 disabled:cursor-not-allowed disabled:border-red-300 disabled:bg-red-300"
