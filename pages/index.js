      ...
      <button onClick={() => signOut()}>Sign out</button> */}
        ...
        {/* <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
          <div className="flex items-center justify-center h-32 bg-gray-200 rounded-lg">
            <article className="flex items-end justify-between gap-4 rounded-lg max-md:flex-col">
              <div>
    ...
    <>
      ...
      >
        <div className="max-w-xl lg:max-w-3xl">
          ...
          <p className="max-w-sm mt-4 leading-relaxed text-gray-500">
            This website is only accessible to admins only. Add new products and
            manage database.
          </p>
          <div className="flex items-center justify-center col-span-6 my-4 sm:flex sm:items-center sm:gap-4">
            <button
              disabled={isLoading}
              onClick={() => {
                setIsLoading(true);
